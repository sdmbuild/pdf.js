...
var TextLayerBuilder = function textLayerBuilder(options) {
  ...
  this.appendText = function textLayerBuilderAppendText(geom, styles) {
    ...
    this.textDivs.push(textDiv);
  	...
  	if(geom.hasOwnProperty("tagName")) {
  		textDiv.setAttribute("class", geom["tagName"]);
  		if(geom.hasOwnProperty("tagProps")) {
  			for(var name in geom["tagProps"]) {
  				textDiv.setAttribute(name, JSON.stringify(geom["tagProps"][name]));
  			}
  		}
  		
  		textDiv.dataset.mc = true;
  		return;
  	} else if(geom.hasOwnProperty("endTag")) {
  		textDiv.dataset.emc = true;
  		return;
  	}
